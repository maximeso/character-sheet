package com.iledeslegendes.charactersheet.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.iledeslegendes.charactersheet.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.iledeslegendes.charactersheet.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.iledeslegendes.charactersheet.domain.CharacterSkill.class.getName() + ".skills");
