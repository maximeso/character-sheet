...
import { getEntities, reset } from './skill.reducer';
  ...
  return (
    <div>
      <h2 id="skill-heading" data-cy="SkillHeading">
        <Translate contentKey="characterSheetApp.skill.home.title">Skills</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="characterSheetApp.skill.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="characterSheetApp.skill.home.createLabel">Create new Skill</Translate>
          </Link>
        </div>
      </h2>
          ...
          {skillList && skillList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="characterSheetApp.skill.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('name')}>
                    <Translate contentKey="characterSheetApp.skill.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('cost')}>
                    <Translate contentKey="characterSheetApp.skill.cost">Cost</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('restriction')}>
                    <Translate contentKey="characterSheetApp.skill.restriction">Restriction</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
              ...
              <tbody>
                {skillList.map((skill, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>
                      {skill.racialCondition ? <Link to={`race/${skill.racialCondition.id}`}>{skill.racialCondition.name}</Link> : ''}
                    </td>
                    <td>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="characterSheetApp.skill.home.notFound">No Skills found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
