...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_RACE: 'race/PARTIAL_UPDATE_RACE',
...
export default (state: RaceState = initialState, action): RaceState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_RACE):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_RACE):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_RACE):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IRace> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_RACE,
